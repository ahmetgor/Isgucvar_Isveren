...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tum_ozgecmisler__ = __webpack_require__(324);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ozgecmis_filtrele_ozgecmis_filtrele__ = __webpack_require__(215);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_user_ser__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_rxjs_add_operator_debounceTime__ = __webpack_require__(309);
...
var TumOzgecmislerPage = /** @class */ (function () {
    ...
    TumOzgecmislerPage.prototype.doInfinite = function (infiniteScroll) {
        var _this = this;
        setTimeout(function () {
            _this.skip = _this.skip + 1;
            _this.ozgecmisSer.getOzgecmisler(_this.searchTerm, _this.detayAra, _this.sirala, _this.skip, _this.limit)
                .then(function (ozgecmisler) {
                //console.log(JSON.stringify(ilanlar)+"ilanlar");
                if (Object.keys(ozgecmisler).length < _this.limit) {
                    _this.scrollEnable = false;
                    ;
                }
                for (var key in ozgecmisler) {
                    _this.ozgecmisList.push(ozgecmisler[key]);
                }
            });
